...
/**
 * Author: MrCrayfish and AlanorMiga
 */
            ...
            matrixStack.push();
            {
                ...
                */
                ...
                if(!OptifineHelper.isShadersEnabled())
                {
                    ...
                    builder.pos(matrix, 0, (float) (size / scale), 0).color(1.0F, 0F, 0F, alpha).tex(0.0F, 0.9375F).overlay(overlay).lightmap(15728880).normal(normal, 0.0F, 1.0F, 0.0F).endVertex();
                    builder.pos(matrix, 0, 0, 0).color(1.0F, 0F, 0F, alpha).tex(0.0F, 0.0F).overlay(overlay).lightmap(15728880).normal(normal, 0.0F, 1.0F, 0.0F).endVertex();
                    builder.pos(matrix, (float) (size / scale), 0, 0).color(1.0F, 0F, 0F, alpha).tex(0.9375F, 0.0F).overlay(overlay).lightmap(15728880).normal(normal, 0.0F, 1.0F, 0.0F).endVertex();
                    builder.pos(matrix, (float) (size / scale), (float) (size / scale), 0).color(1.0F, 0F, 0F, alpha).tex(0.9375F, 0.9375F).overlay(overlay).lightmap(15728880).normal(normal, 0.0F, 1.0F, 0.0F).endVertex();
                }
