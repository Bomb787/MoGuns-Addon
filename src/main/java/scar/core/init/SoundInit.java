...
public class SoundInit {
     ...
     */
	public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, ScarAddon.MOD_ID);
	...
	private static RegistryObject<SoundEvent> register(String key) {
		...
		return SOUNDS.register(key, () -> new SoundEvent(new ResourceLocation(ScarAddon.MOD_ID, key)));
